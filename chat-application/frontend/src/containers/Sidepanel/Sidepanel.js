        ...
        <div id="profile">
            <div className="wrap">
                ...
                <div id="status-options">
                    <ul>
                        <li id="status-online" className="active"><span
                            className="status-circle"></span>
                            <p>Online</p>
                        </li>
                        <li id="status-away"><span
                            className="status-circle"></span>
                            <p>Away</p>
                        </li>
                        <li id="status-busy"><span
                            className="status-circle"></span>
                            <p>Busy</p>
                        </li>
                        <li id="status-offline"><span
                            className="status-circle"></span>
                            <p>Offline</p>
                        </li>
                    </ul>
            ...
            <ul>
                <li className="contact">  {/* <!-- active --> */}
                    <div className="wrap">
                        ...
                        {/* <span className="contact-status"></span> OFFLINE */}
                        {/* <span className="contact-status busy"></span> BUSY */}
                        {/* <span className="contact-status away"></span> AWAY */}

                        <img src="http://emilcarlsson.se/assets/louislitt.png"
                            alt="" />
                        <div className="meta">
                            <p className="name">Louis Litt</p>
                            <p className="preview">You just got LITT up, Mike.
                            </p>
                        </div>
                    </div>
                </li>
                <li className="contact active">
                    <div className="wrap">
                        ...
                        <div className="meta">
                            ...
                            <p className="preview">Wrong. You take the gun, or
                                you pull out a bigger one. Or, you call
                                their bluff. Or, you do any one of a hundred
                                and forty six other things.</p>
                        </div>
                    </div>
                </li>
                <li className="contact">
                    <div className="wrap">
                        ...
                        <div className="meta">
                            ...
                            <p className="preview">I was thinking that we could
                                have chicken tonight, sounds good?</p>
                        </div>
                    </div>
                </li>
                <li className="contact">
                    <div className="wrap">
                        ...
                        <div className="meta">
                            ...
                            <p className="preview">Mike, I know everything! I'm
                                Donna..</p>
                        </div>
                    </div>
                </li>
                <li className="contact">
                    <div className="wrap">
                        ...
                        <div className="meta">
                            ...
                            <p className="preview">Have you finished the draft
                                on the Hinsenburg deal?</p>
                        </div>
                    </div>
                </li>
                <li className="contact">
                ...
                <li className="contact">
                    <div className="wrap">
                        ...
                        <div className="meta">
                            ...
                            <p className="preview">We'll meet again, Mike. Tell
                                Jessica I said 'Hi'.</p>
                        </div>
                    </div>
                </li>
                <li className="contact">
                    <div className="wrap">
                        ...
                        <div className="meta">
                            ...
                            <p className="preview">I've sent you the files for
                                the Garrett trial.</p>
                        </div>
                    </div>
                </li>
                ...
                <li className="contact">
                    <div className="wrap">
                        ...
                        <div className="meta">
                            ...
                            <p className="preview"><span>You:</span> That's
                                bullshit. This deal is solid.</p>
                        </div>
                    </div>
                </li>
            </ul>
